...
def update_macos_ver():
    """Update macos_ver dictionary with latest macOS versions from Wikipedia."""
    global macos_ver
...
# Call the function to update macos_ver
updated_macos_ver = update_macos_ver()
print(updated_macos_ver)
